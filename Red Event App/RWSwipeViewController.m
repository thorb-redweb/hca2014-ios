...
-(void)setAppearance{
	...
	[helper setBackgroundTileImageOrColor:_pageViewController.view localImageName:[RWLOOK BACKGROUNDIMAGE] localColorName:[RWLOOK BACKGROUNDCOLOR] globalName:[RWLOOK DEFAULT_BACKCOLOR]];
