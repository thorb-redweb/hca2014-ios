...
-(void)setAppearance{
    ...
    [helper.label setFontForLast:[RWLOOK TITLESIZE] globalSizeName:[RWLOOK DEFAULT_TITLESIZE]
           localStyleName:[RWLOOK TITLESTYLE] globalStyleName:[RWLOOK DEFAULT_TITLESTYLE]];
    [helper.label setShadowColorForLast:[RWLOOK TITLESHADOWCOLOR] globalName:[RWLOOK DEFAULT_BACKTEXTSHADOWCOLOR]];
    [helper.label setShadowOffsetForLast:[RWLOOK TITLESHADOWOFFSET] globalName:[RWLOOK DEFAULT_TITLESHADOWOFFSET]];
    ...
    [helper.label setFontForLast:[RWLOOK PUSHMESSAGEDETAIL_AUTHORTEXTSIZE] globalSizeName:[RWLOOK DEFAULT_ITEMTITLESIZE]
           localStyleName:[RWLOOK PUSHMESSAGEDETAIL_AUTHORTEXTSTYLE] globalStyleName:[RWLOOK DEFAULT_ITEMTITLESTYLE]];
    [helper.label setShadowColorForLast:[RWLOOK PUSHMESSAGEDETAIL_AUTHORTEXTSHADOWCOLOR] globalName:[RWLOOK DEFAULT_BACKTEXTSHADOWCOLOR]];
    [helper.label setShadowOffsetForLast:[RWLOOK PUSHMESSAGEDETAIL_AUTHORTEXTSHADOWOFFSET] globalName:[RWLOOK DEFAULT_ITEMTITLESHADOWOFFSET]];
    ...
    [helper.label setFontForLast:[RWLOOK PUSHMESSAGEDETAIL_SENTTEXTSIZE] globalSizeName:[RWLOOK DEFAULT_ITEMTITLESIZE]
           localStyleName:[RWLOOK PUSHMESSAGEDETAIL_SENTTEXTSTYLE] globalStyleName:[RWLOOK DEFAULT_ITEMTITLESTYLE]];
    [helper.label setShadowColorForLast:[RWLOOK PUSHMESSAGEDETAIL_SENTTEXTSHADOWCOLOR] globalName:[RWLOOK DEFAULT_BACKTEXTSHADOWCOLOR]];
    [helper.label setShadowOffsetForLast:[RWLOOK PUSHMESSAGEDETAIL_SENTTEXTSHADOWOFFSET] globalName:[RWLOOK DEFAULT_ITEMTITLESHADOWOFFSET]];

    [helper.label setColor:_lblMessage localName:[RWLOOK TEXTCOLOR] globalName:[RWLOOK DEFAULT_BACKTEXTCOLOR]];
    [helper.label setFontForLast:[RWLOOK TEXTSIZE] globalSizeName:[RWLOOK DEFAULT_TEXTSIZE]
    ...
    [helper.label setShadowOffsetForLast:[RWLOOK TEXTSHADOWOFFSET] globalName:[RWLOOK DEFAULT_TEXTSHADOWOFFSET]];
    ...
    [helper.button setTitleColorForLast:[RWLOOK BACKBUTTONTEXTCOLOR] globalName:[RWLOOK DEFAULT_ALTTEXTCOLOR]];
    [helper.button setTitleFontForLast:[RWLOOK BACKBUTTONTEXTSIZE] globalSizeName:[RWLOOK DEFAULT_ITEMTITLESIZE] localStyleName:[RWLOOK BACKBUTTONTEXTSTYLE] globalStyleName:[RWLOOK DEFAULT_ITEMTITLESTYLE]];
    [helper.button setTitleShadowColorForLast:[RWLOOK BACKBUTTONTEXTSHADOWCOLOR] globalName:[RWLOOK DEFAULT_ALTTEXTSHADOWCOLOR]];
    [helper.button setTitleShadowOffsetForLast:[RWLOOK BACKBUTTONTEXTSHADOWOFFSET] globalName:[RWLOOK DEFAULT_ITEMTITLESHADOWOFFSET]];
}
