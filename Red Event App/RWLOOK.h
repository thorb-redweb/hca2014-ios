...
+ (NSString *)TEXTSIZE;
+ (NSString *)TEXTSTYLE;
+ (NSString *)TEXTFIELDCOLOR;
+ (NSString *)TEXTFIELDSIZE;
...
+ (NSString *)APPEARANCEHELPER_DEF_BACKGROUNDCOLOR;
+ (NSString *)APPEARANCEHELPER_DEF_BACKGROUNDIMAGE;
+ (NSString *)APPEARANCEHELPER_DEF_ICON;
+ (NSString *)APPEARANCEHELPER_DEF_TEXTSIZE;
+ (NSString *)APPEARANCEHELPER_DEF_TEXTSTYLE;
...
//RedUploadFolderView
+(NSString *)REDUPLOAD_ITEMBACKGROUNDCOLOR;
+(NSString *)REDUPLOADFOLDERVIEW_LISTBACKGROUNDCOLOR;
+(NSString *)REDUPLOADFOLDERVIEW_LISTLINECOLOR;
+(NSString *)REDUPLOADFOLDERVIEW_CAMERABUTTONIMAGE;
+(NSString *)REDUPLOADFOLDERVIEW_ARCHIVEBUTTONIMAGE;

//RedUploadPictureView
+ (NSString *)REDUPLOADPICTUREVIEW_APPROVALBOXCOLOR;
